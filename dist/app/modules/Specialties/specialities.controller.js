...
exports.SpecialitiesControllers = void 0;
...
const createSpecialty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield specialities_service_1.SpecialitiesServices.createSpecialtyIntoDB(req);
...
const getAllSpecialities = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield specialities_service_1.SpecialitiesServices.getAllSpecialitiesFromDB();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteSpecialty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield specialities_service_1.SpecialitiesServices.deleteSpecialtyFromDB(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
exports.SpecialitiesControllers = {
    createSpecialty,
    getAllSpecialities,
    deleteSpecialty,
};
